import "./calculatorFormContainer.css";
import React, { forwardRef, useEffect, useState } from "react";
import isValidation, {
  isCalculateButtonDisabled,
} from "../../shared/app-factory";
...
const Calculator = (props) => {
  ...
  let interestType = location.state.interestType;
  ...
  function onCalculationClick(props) {
    navigate("/result", {
      state: {
        allProps: props,
      },
  ...
  return (
        ...
        >
          <div className="imageContainer">
            {interestType === "compound interest" ? (
              <config.compoundInterestNoBgd />
            ) : (
              <config.intCalculatorSvgNoBgd />
            )}
          </div>
            ...
            <form className="formStyle">
              <div
                className={
                  errorMsg !== ""
                    ? switchValue
                      ? "c-red errorContainer h-30 labelContainer-black"
                      : "c-red errorContainer h-30 labelContainer-white"
                    : "h-30"
                }
              >
                {errorMsg !== "" ? errorMsg : ""}
              ...
              <div>
                <label
                  className={
                    switchValue
                      ? "display-block labelContainer labelContainer-black"
                      : "display-block labelContainer labelContainer-white"
                  }
                >
              ...
              <div>
                <label
                  className={
                    switchValue
                      ? "labelStyle labelContainer labelContainer-black"
                      : "labelStyle labelContainer labelContainer-white"
                  }
                >
                  Amount *
                </label>
              ...
              <div className="buttonContainer">
                <input
                  ...
                  className={
                    isButtonDisabled
                      ? "submitStyle button-disabled w-100"
                      : "submitStyle button-enabled w-100"
                  }
                />
              </div>
            </form>
    ...
    //       <select
    //         onChange={changeInterestType}
    //         value={interestSelectType}
    //         className={
    //           interestSelectType == "" ? "my_class c-grey" : "my_class"
    //         }
    //       >
    ...
    //               key={key}
    //               value={e.value}
    //               disabled={e.name == "Please select interest"}
    //             >
    //               {e.name}
    //             </option>
    //           );
